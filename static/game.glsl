...
void main(void) {
  ...
  //vec2 mouseuv = mouse.xy-canvassize.xy*0.5;
  //mouseuv /= canvassize.y;
  //uv += mouseuv;

  vec3 lookAt = vec3(0.0);
  float camrot = mouse.x*2.0*3.14159;
  vec3 ro = vec3(6.0*cos(camrot), 4.0*mouse.y, 6.0*sin(camrot));
